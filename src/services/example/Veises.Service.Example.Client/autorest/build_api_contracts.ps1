...
$swaggerFileUrl = "http://localhost:5000/swagger/v1/swagger.json";

$swaggerFilePath = Join-Path $scriptLocation "swagger.json";

$contractsPath = Join-Path $scriptLocation "../contracts/";

$constractNamespace = "Veises.Service.Example.Client";
