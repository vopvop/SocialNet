...
namespace Veises.SocialNet.Identity.Contracts
{
    ...
    /// </summary>
    public partial class VeisesUserIdentityAPI10 : ServiceClient<VeisesUserIdentityAPI10>, IVeisesUserIdentityAPI10
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the VeisesUserIdentityAPI10 class.
        /// </summary>
        /// <param name='handlers'>
        /// Optional. The delegating handlers to add to the http client pipeline.
        /// </param>
        public VeisesUserIdentityAPI10(params DelegatingHandler[] handlers) : base(handlers)
        {
            Initialize();
        }
        ...
        /// Optional. The delegating handlers to add to the http client pipeline.
        /// </param>
        public VeisesUserIdentityAPI10(HttpClientHandler rootHandler, params DelegatingHandler[] handlers) : base(rootHandler, handlers)
        {
            Initialize();
        }
        ...
        /// </exception>
        public VeisesUserIdentityAPI10(System.Uri baseUri, params DelegatingHandler[] handlers) : this(handlers)
        {
            if (baseUri == null)
            {
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        public VeisesUserIdentityAPI10(System.Uri baseUri, HttpClientHandler rootHandler, params DelegatingHandler[] handlers) : this(rootHandler, handlers)
        {
            if (baseUri == null)
            {
                throw new System.ArgumentNullException("baseUri");
        ...
        public async Task<HttpOperationResponse<UserIdentity>> ApiVversionIdentityByIdGetWithHttpMessagesAsync(string id, string version, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Create Result
            var _result = new HttpOperationResponse<UserIdentity>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = SafeJsonConvert.DeserializeObject<UserIdentity>(_responseContent, DeserializationSettings);
                }
        ...
        public async Task<HttpOperationResponse<UserIdentity>> ApiVversionIdentityByIdPutWithHttpMessagesAsync(string id, string version, UpdateUserIdentity updateUserIdentity = default(UpdateUserIdentity), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if(updateUserIdentity != null)
            {
                _requestContent = SafeJsonConvert.SerializeObject(updateUserIdentity, SerializationSettings);
        ...
        public async Task<HttpOperationResponse<UserIdentity>> ApiVversionIdentityPostWithHttpMessagesAsync(string version, CreateUserIdentity createIdentityModel = default(CreateUserIdentity), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if(createIdentityModel != null)
            {
                _requestContent = SafeJsonConvert.SerializeObject(createIdentityModel, SerializationSettings);
                _httpRequest.Content = new StringContent(_requestContent, System.Text.Encoding.UTF8);
                _httpRequest.Content.Headers.ContentType =System.Net.Http.Headers.MediaTypeHeaderValue.Parse("application/json-patch+json; charset=utf-8");
            }
            // Send Request
